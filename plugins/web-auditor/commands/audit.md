...
description: Perform passive security audit of a target website. Scans web app, API, infrastructure, and supply chain vulnerabilities.
model: claude-opus-4-6
argument-hint: <url> [--depth N] [--output-dir path]
---

# Passive Web Security Audit

You are a security auditor performing a comprehensive passive security assessment.
...
```
⚠️ Usage: /pentest <url> [--depth N] [--output-dir path]
...
Target: {URL}
Depth: {depth}
Output: {output_dir}/audit-{domain}-security-{date}.md
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Starting scan...
```
...
Launch the pentester coordinator agent using the Task tool:

```
Task(
  subagent_type: "pentester",
  description: "Security audit of {domain}",
  prompt: "Perform a comprehensive passive security audit of {URL}. Crawl depth: {depth}. Output directory: {output_dir}. Follow the complete workflow: Phase 1 (crawl/recon), Phase 2 (4 parallel scanning agents), Phase 3 (consolidation and report generation)."
)
```
...
📄 Full report: {output_dir}/audit-{domain}-security-{date}.md
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
