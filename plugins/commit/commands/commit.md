...
argument-hint: [task-id] [--no-coauthor]
...
- If the second argument ($2) equals "--no-coauthor", DO NOT include the Co-authored-by line and any information about Claude Code.
