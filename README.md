...
|--------|---------|-------------|
| [Code Review](docs/plugins/code-review.md) | 1.8.0 | Security, architecture, and code quality analysis with OWASP compliance. Save reviews to file, fix issues via `/fix-report` with paginated checklist. Optional `--verify` for cross-analysis and adversarial review |
