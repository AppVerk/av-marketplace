...
|--------|---------|-------------|
| [Code Review](docs/plugins/code-review.md) | 1.11.0 | Security, architecture, and code quality analysis with OWASP compliance. Unique issue IDs (SEC-001, PERF-001, DOC-001, ...), fix by ID via `/fix SEC-001` or batch via `/fix-report`. Built-in cross-analysis and adversarial review via Cross-Verifier + Challenger |
